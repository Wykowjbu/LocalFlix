  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#141414] text-white">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_18%,rgba(229,9,20,.2),transparent_28%),linear-gradient(180deg,rgba(0,0,0,.7),#141414_82%)]" />
      </div>
      ...
      <section className="relative z-10 flex min-h-screen items-center justify-center px-4 py-28">
        <form onSubmit={handleSubmit} className="w-full max-w-[450px] rounded-sm bg-black/75 px-6 py-10 shadow-[0_12px_40px_rgba(0,0,0,.45)] sm:px-14 sm:py-12">
          <h1 className="mb-2 text-[32px] font-bold leading-tight">Tạo tài khoản</h1>
          <p className="mb-7 text-[16px] leading-6 text-[#b3b3b3]">Profile đầu tiên sẽ dùng tên bạn nhập ở đây.</p>

          <div className="space-y-4">
            <label className="block">
              <span className="sr-only">Tên profile</span>
              <input
                value={name}
